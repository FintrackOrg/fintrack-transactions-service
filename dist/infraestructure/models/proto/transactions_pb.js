...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.transactions.GetTransactionsByAccountResponse.toObject = function (includeInstance, msg) {
        var f, obj = {
            transactionsList: jspb.Message.toObjectList(msg.getTransactionsList(), proto.transactions.Transaction.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.transactions.GetTransactionsByAccountResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.transactions.Transaction.serializeBinaryToWriter);
    }
};
/**
...
proto.transactions.GetTransactionsByAccountResponse.prototype.getTransactionsList = function () {
    return /** @type{!Array<!proto.transactions.Transaction>} */ (jspb.Message.getRepeatedWrapperField(this, proto.transactions.Transaction, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.transactions.Transaction.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            detailsList: jspb.Message.toObjectList(msg.getDetailsList(), proto.transactions.TransactionDetail.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.transactions.Transaction.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(8, f, proto.transactions.TransactionDetail.serializeBinaryToWriter);
    }
};
/**
...
proto.transactions.Transaction.prototype.getDetailsList = function () {
    return /** @type{!Array<!proto.transactions.TransactionDetail>} */ (jspb.Message.getRepeatedWrapperField(this, proto.transactions.TransactionDetail, 8));
};
/**
